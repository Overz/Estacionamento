...
-- TICKET
INSERT INTO `dbestacionamento`.`ticket` (`idticket`, `idCliente`, `n_ticket`, `valor`, `tipo`, `hr_validacao`, `statusTicket`) VALUES ('1', '1', '0101010101', '0', 'DINHEIRO', '2020-01-01 13:00:00', '0');
INSERT INTO `dbestacionamento`.`ticket` (`idticket`, `idCliente`, `n_ticket`, `valor`, `tipo`, `hr_validacao`, `statusTicket`) VALUES ('2', '2', '0202020202', '0', 'CARTÃO', '2020-02-02 14:00:00', '0');
INSERT INTO `dbestacionamento`.`ticket` (`idticket`, `idCliente`, `n_ticket`, `valor`, `tipo`, `hr_validacao`, `statusTicket`) VALUES ('3', '3', '0303030303', '0', 'DINHEIRO', '2020-03-03 15:00:00', '0');
INSERT INTO `dbestacionamento`.`ticket` (`idticket`, `idCliente`, `n_ticket`, `valor`, `tipo`, `hr_validacao`, `statusTicket`) VALUES ('4', '4', '0404040404', '0', 'CARTÃO', '2020-04-04 16:00:00', '1');
INSERT INTO `dbestacionamento`.`ticket` (`idticket`, `idCliente`, `n_ticket`, `valor`, `tipo`, `hr_validacao`, `statusTicket`) VALUES ('5', '5', '0505050505', '0', 'DINHEIRO', '2020-05-05 17:00:00', '1');
INSERT INTO `dbestacionamento`.`ticket` (`idticket`, `n_ticket`, `valor`, `tipo`, `hr_validacao`, `statusTicket`) VALUES ('6', '0606060606', '0', 'DINHEIRO', '2020-05-05 17:00:00', '0');
...
INSERT INTO `dbestacionamento`.`movimento` (`idmovimento`, `idTicket`, `hr_entrada`) VALUES ('6', '6', now());
