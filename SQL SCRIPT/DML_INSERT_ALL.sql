...
-- TICKET
INSERT INTO `dbestacionamento`.`ticket` (`idticket`, `idCliente`, `n_ticket`, `valor`, `tipo`, `hr_validacao`,
                                         `statusTicket`)
VALUES ('1', '1', '0101010101', '0', 'DINHEIRO', '2020-01-01 13:00:00', '0');
INSERT INTO `dbestacionamento`.`ticket` (`idticket`, `idCliente`, `n_ticket`, `valor`, `tipo`, `hr_validacao`,
                                         `statusTicket`)
VALUES ('2', '2', '0202020202', '0', 'CARTÃO', '2020-02-02 14:00:00', '0');
INSERT INTO `dbestacionamento`.`ticket` (`idticket`, `idCliente`, `n_ticket`, `valor`, `tipo`, `hr_validacao`,
                                         `statusTicket`)
VALUES ('3', '3', '0303030303', '0', 'DINHEIRO', '2020-03-03 15:00:00', '0');
INSERT INTO `dbestacionamento`.`ticket` (`idticket`, `idCliente`, `n_ticket`, `valor`, `tipo`, `hr_validacao`,
                                         `statusTicket`)
VALUES ('4', '4', '0404040404', '0', 'CARTÃO', '2020-04-04 16:00:00', '1');
INSERT INTO `dbestacionamento`.`ticket` (`idticket`, `idCliente`, `n_ticket`, `valor`, `tipo`, `hr_validacao`,
                                         `statusTicket`)
VALUES ('5', '5', '0505050505', '0', 'DINHEIRO', '2020-05-05 17:00:00', '1');

-- CONTRATO
INSERT INTO `dbestacionamento`.`contrato` (`idcontrato`, `n_cartao`, `dt_entrada`, `dt_saida`, `ativo`, `valor`)
VALUES ('1', '00000000001', '2020-01-01 12:00:01', '2020-01-5 17:00:05', '1', '200.00');
INSERT INTO `dbestacionamento`.`contrato` (`idcontrato`, `n_cartao`, `dt_entrada`, `dt_saida`, `ativo`, `valor`)
VALUES ('2', '00000000002', '2020-02-02 12:00:02', '2020-02-10 17:00:10', '1', '50.00');
INSERT INTO `dbestacionamento`.`contrato` (`idcontrato`, `n_cartao`, `dt_entrada`, `dt_saida`, `ativo`, `valor`)
VALUES ('3', '00000000003', '2020-03-03 12:00:03', '2020-03-15 17:00:15', '1', '25.00');
INSERT INTO `dbestacionamento`.`contrato` (`idcontrato`, `n_cartao`, `dt_entrada`, `dt_saida`, `ativo`, `valor`)
VALUES ('4', '00000000004', '2020-04-04 12:00:04', '2020-04-20 17:00:20', '0', '15.00');
INSERT INTO `dbestacionamento`.`contrato` (`idcontrato`, `n_cartao`, `dt_entrada`, `dt_saida`, `ativo`, `valor`)
VALUES ('5', '00000000005', '2020-05-05 12:00:05', '2020-05-25 17:00:25', '0', '200.00');
...
-- MOVIMENTO
INSERT INTO `dbestacionamento`.`movimento` (`idmovimento`, `idTicket`, `idPlano`, `hr_entrada`, `hr_saida`)
VALUES ('1', '1', '1', '2020-01-01 12:00:00', '2020-01-01 17:00:00');
INSERT INTO `dbestacionamento`.`movimento` (`idmovimento`, `idTicket`, `idPlano`, `hr_entrada`, `hr_saida`)
VALUES ('2', '2', '3', '2020-01-01 12:00:00', '2020-01-01 17:00:00');
INSERT INTO `dbestacionamento`.`movimento` (`idmovimento`, `idTicket`, `idPlano`, `hr_entrada`, `hr_saida`)
VALUES ('3', '3', '2', '2020-01-01 12:00:00', '2020-01-01 17:00:00');
INSERT INTO `dbestacionamento`.`movimento` (`idmovimento`, `idTicket`, `idPlano`, `hr_entrada`, `hr_saida`)
VALUES ('4', '4', '5', '2020-01-01 12:00:00', '2020-01-01 17:00:00');
INSERT INTO `dbestacionamento`.`movimento` (`idmovimento`, `idTicket`, `idPlano`, `hr_entrada`, `hr_saida`)
VALUES ('5', '5', '4', '2020-01-01 12:00:00', '2020-01-01 17:00:00');
